...
shinyServer(function(input, output, session) {
  ...
  output$map1 <- renderLeaflet({
    ...
    pal1 <- colorBin(color[[1]], bins = c(0, 100, 200, 300, 400, 500, 1000, 10000))
    ...
    pal2 <- colorBin(color[[2]], bins = c(0, 10, 15, 20, 25, 30, 35, 40, 1000))
    ...
    pal3 <- colorBin(color[[3]], bins = c(0, 10, 20, 30, 40, 1000))
    ...
    pal4 <- colorBin(color[[4]], bins = c(0, 0.25, 0.5, 1000))
